...
function getEditorClassName(variant: SharedMessageEditorVariant) {
  if (variant === "customer") {
    return "customer-service-system-scrollbar min-h-12 max-h-40 overflow-y-auto px-1.5 py-1 text-sm leading-6 text-foreground outline-none [&_p]:m-0 [&_p+*]:mt-2 [&_.customer-service-system-editor-image-wrap]:my-2 [&_.customer-service-system-editor-image]:max-h-64 [&_.customer-service-system-editor-image]:max-w-full [&_.customer-service-system-editor-image]:rounded-lg [&_.customer-service-system-editor-image]:object-contain [&_.customer-service-system-editor-image-wrap-uploading_.customer-service-system-editor-image]:opacity-55"
  }
  return "h-full min-h-12 max-h-[20vh] overflow-y-auto px-1.5 py-1 text-sm leading-6 text-foreground outline-none sm:max-h-none [&_.ProseMirror-focused]:outline-none [&_p]:m-0 [&_p+.customer-service-system-editor-image-wrap]:mt-2 [&_.customer-service-system-editor-image-wrap]:my-2 [&_.customer-service-system-editor-image]:max-h-64 [&_.customer-service-system-editor-image]:max-w-full [&_.customer-service-system-editor-image]:rounded-md [&_.customer-service-system-editor-image]:object-contain [&_.customer-service-system-editor-image-wrap-uploading_.customer-service-system-editor-image]:opacity-55 [&_p.is-editor-empty:first-child]:before:text-muted-foreground"
}
