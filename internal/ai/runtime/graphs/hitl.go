...
func ConfirmOrCancelPrompt() string          { return i18nx.Get("graph.confirmOrCancel") }
func NeedExplicitConfirmationPrompt() string { return i18nx.Get("graph.needExplicitConfirmation") }
func ConfirmationExpiredReply() string       { return i18nx.Get("graph.confirmationExpired") }
func CancelCreateTicketReply() string        { return i18nx.Get("graph.cancelCreateTicket") }
func CancelHandoffReply() string             { return i18nx.Get("graph.cancelHandoff") }
